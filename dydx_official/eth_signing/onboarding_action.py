...
EIP712_ONBOARDING_ACTION_STRUCT_STRING = "dYdX(" + "string action," + "string onlySignOn" + ")"
EIP712_ONBOARDING_ACTION_STRUCT_TESTNET = [
    {"type": "string", "name": "action"},
]
EIP712_ONBOARDING_ACTION_STRUCT_STRING_TESTNET = "dYdX(" + "string action" + ")"
...
class SignOnboardingAction(SignOffChainAction):
    ...
    def get_eip712_message(
        ...
        **message,
        ...
        # On mainnet, include an extra onlySignOn parameter.
        if self.network_id == NETWORK_ID_MAINNET:
            eip712_message["message"]["onlySignOn"] = "https://trade.dydx.exchange"
