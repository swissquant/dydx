...
class Private(object):
    ...
    def create_order(
        ...
        expiration_epoch_seconds = expiration_epoch_seconds or iso_to_epoch_seconds(expiration)
    ...
    def create_fast_withdrawal(
        ...
        if not signature:
            ...
            fact = get_transfer_erc20_fact(
                ...
                token_address=(TOKEN_CONTRACTS[COLLATERAL_ASSET][self.network_id]),
    ...
    def sign(
        ...
        message_string = iso_timestamp + method + request_path + (json_stringify(data) if data else "")
