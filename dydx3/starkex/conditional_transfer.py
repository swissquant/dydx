...
class SignableConditionalTransfer(Signable):
    def __init__(
        ...
        receiver_public_key = (
            receiver_public_key if isinstance(receiver_public_key, int) else int(receiver_public_key, 16)
        )
    ...
    def _calculate_hash(self):
        ...
        part_3 <<= CONDITIONAL_TRANSFER_FIELD_BIT_LENGTHS["expiration_epoch_hours"]
